...
replace (
	...
	github.com/containerd/containerd v1.6.9 => github.com/containerd/containerd v1.6.28
	...
	go.opentelemetry.io/contrib v0.20.0 => go.opentelemetry.io/contrib v1.0.0
